'''
Este código é uma representação do que acontece na
...
print("-"40)
#2ª froma de operação do for 
for contdor in range(1,11,2): # o 3ª parâmetro indica
como os valores serão incrementados(alteração de valor)
    print(contador)
